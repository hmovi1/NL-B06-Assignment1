...
What are some differences between interfaces and types in TypeScript?
     ...
     করার সময়ে কিভাবে এপ্লাই করা হচ্ছে সেইভাবে দেখালে আরো ভাল ভাবে বুঝা যাবে।
       ...
       একটি primitive/object/Union/Function/Tuple Type declare করতে হচ্ছে,যেনো আমরা তা বারবার বিভিন্ন ব্লকে বার বার Type declare না করে বরং বারবার ব্যবহার করতে পারি।
       দেখাই যাচ্ছে এটি বিভিন্ন ধরণের ডেটা টাইপ নিয়ে কাজ করতে পারে। কিন্তু ইন্টারফেইস শুধুমাত্র অব্জেক্ট বা ক্লাস এর জন্য ইনভেন্টেড একটি ফিচার।তবে এটি তার নিজ জায়গায় খুবি ইফেক্টিভ।
